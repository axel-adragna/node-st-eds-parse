...
function splitQuotes(str, sep) {
    ...
    // if the separator is encountered and the double quote is closed, ends the parsing of the current element. otherwise continues.
    // this is needed to avoid stop parsing if the separator is encountered in between quotes.
